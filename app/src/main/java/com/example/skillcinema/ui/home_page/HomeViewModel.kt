...
import com.example.skillcinema.ui.Helper.getMonth
import com.example.skillcinema.ui.Helper.getYear
...
//    private val _newMovies = MutableStateFlow<ApiNewMovies?>(null)
//    val newMovies = _newMovies.asStateFlow()
    ...
    private fun getNewMovie() {
        ...
        compositeDisposable.add(
            serviceApi.getNewMovies(year = getYear(), month = getMonth()).subscribe({
