...
class InterestedAdapter(
    private val movies: List<WasInterestedHolder>,
    ...
    inner class MovieViewHolder(private val binding: ItemMoviesBinding) :
        ...
        fun bind(movie: WasInterestedHolder) = with(binding) {
            ...
            movieName.text = movie.name_ru
            movieType.text = "${movie.country}, ${movie.genre}"
            rate.text = movie.raiting.toString()
        }
    }
